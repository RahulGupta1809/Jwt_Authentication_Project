 ...
 * 
 * import com.example.employee.jpa.filter.JwtAuthFilter; import
 * com.example.employee.jpa.service.UserInfoUserDetailsService;
 * 
 * @Configuration
 * 
 * @EnableWebSecurity
 ...
 * =User.withUsername("Swathi") .password( encoder.encode("swathi"))
 * .roles("ADMIN") .build(); UserDetails user =User.withUsername("Ron")
 * .password(encoder.encode("ron")) .roles("USER") .build(); return new
 ...
 * .requestMatchers("/api/addUser","/api/authenticate").permitAll() .and()
 * .authorizeHttpRequests()
 * .requestMatchers("/api/employees/**").authenticated().and()
 ...
 * .requestMatchers("/api/employees/**").authenticated() .and().formLogin()
 * .and().build();
 */
